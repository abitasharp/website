...
namespace Abitasharp.Migrations
{
    ...
    [Migration("20180627151957_identity_work")]
    partial class identity_work
    {
            ...
            modelBuilder.Entity("Abitasharp.Models.Annuncio", b =>
                {
                    ...
                    b.HasOne("Abitasharp.Models.TipologiaAnnunci", "Tipologia")
                        .WithMany()
                        .HasForeignKey("TipologiaAnnunciId");
